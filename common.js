...
var Util = {
  ...
  timestamp:        function()                  { return window.performance ? performance.now() : Date.now();    },
...
var COLORS = {
  ...
  TREE: '#005108',
  FOG:  '#005108',
  LIGHT:  { road: '#B8956A', grass: '#8B9456', rumble: '#6B5D3F', lane: '#D4C4A8'  },
  DARK:   { road: '#A67C52', grass: '#7A8B4F', rumble: '#8B7355'                   },
